...
<form class="d-flex float-right mb-3" type="get" action="{{ route('advance.post') }}">

<input type="date"  name="start_date" value="" class="form-control" title="Tarikh Mula" style="height:31px" required>
<input type="date"  name="end_date" value="" class="form-control" title="Tarikh Akhir" style="height:31px" required>
...
<table  class="table table-bordered table-striped table-sm">
  ...
  <td> 
         <a class="btn btn-sm" style="background-color:CadetBlue;" data-toggle="modal" id="InfoButton1" data-target="#InfoModal1"
                    data-attr="{{ route('info.manual', $manual->id) }}" title="Edit Borang"><i class="fa fa-info" style="font-size:18px;color:white">&nbsp;info</i></a> 
...
<div class="clearfix">
    ...
    @if ($manuals->links()->paginator->hasPages())
