...
<div style="position: fixed; background-repeat:no-repeat; z-index: -1000; ">
      <img src="./storage/logo/sijilbaruppd1.png" style="width: 794px; height: 1123px;">
</div>
...
<table align="center" style="text-align:center; width: 100%;" class="table table-borderless table-sm">
    <tbody>
                @if ($data['logo'] == 'ppdag' )
                <tr>
                    <td style="text-align:center"><img src="./storage/logo/logoppdag.png" alt height="15%" width="35%" ></td>
                </tr>
                @elseif ($data['logo'] == 'ppdj' )
                <tr>
                    <td style="text-align:center"><img src="./storage/logo/logoppdj.png" alt height="16%" width="36%"  ></td>
                </tr>
                @elseif ($data['logo'] == 'ppdmt' )
                <tr>
                    <td style="text-align:center"><img src="./storage/logo/logoppdmt.png" alt height="15%" width="35%"  ></td>
                </tr>
                @else
                <tr>
                    <td style="text-align:center"><img src="./storage/logo/jpnmelaka.png" alt height="12%" width="30%" ></td>
                </tr>
                @endif
                </tbody>
    </table>
...
<div class="next0" >
    ...
    <table align="center" style="text-align:center;" class="table table-borderless table-sm">
        <tbody>
            <tr>
                <td><h1>{{$data['jsijil']}}</h1></td>
            </tr>
        </tbody>
    </table>
...
<div class="next1" >
    ...
    <tbody>
                ...
                <tr>
                    ...
                    <span style="font-size:24px"><span class="uppercase" style="font-family:Times New Roman, Times, serif"><b>{{ $data['peserta'] }}</b></span></span>
                    </td>
                </tr>
                <tr>
               ...
               <tr>
                    <td style="text-align:center">
                    <span style="font-size:24px"><span class="uppercase" style="font-family:Times New Roman, Times, serif"><b>{{ $data['sekolah'] }}</b></span></span>
                    </td>
                </tr>
                <tr>
...
<div class="next2" >
    ...
    <tbody>                
                ...
                <tr>
                    <td style="text-align:center"><span style="font-family:Times New Roman,Times,serif"><span style="font-size:14px">sebagai<br></span>&nbsp;<span style="font-size:16px"><b>{{$data['state2']}}</b></span></span></td>
                </tr>
...
<div class="next3" >
    ...
    <tbody>
                @if ($data['sainpath'] == 'p1' )
                <tr>
                    <td style="text-align:center"><img src="./storage/sain/p1.png" alt height="3%" width="20%" ></td>
                </tr>
                @elseif ($data['sainpath'] == 'kppdag' )
                <tr>
                    <td style="text-align:center"><img src="./storage/sain/kppdag1.png" alt height="8%" width="25%"  ></td>
                </tr>
                @elseif ($data['sainpath'] == 'kppdmt' )
                <tr>
                    <td style="text-align:center"><img src="./storage/sain/kppdmt.png" alt height="8%" width="25%"  ></td>
                </tr>
                @elseif ($data['sainpath'] == 'kppdj' )
                <tr>
                    <td style="text-align:center"><img src="./storage/sain/kppdj.png" alt height="8%" width="25%"  ></td>
                </tr>
                @else
