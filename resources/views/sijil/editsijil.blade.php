...
<div class="container">
    <form id = "sijils1" method="POST" action="{{ route('update.sijil') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <tr>
                    ...
                    <select name="jsijil" class="form-control" style="width:300px;height:33px" required>
                        ...
                        <option value="Anugerah Perkhidmatan Cemerlang" >Anugerah Perkhidmatan Cemerlang</option>
                        <option value="Anugerah Inovasi" >Anugerah Inovasi</option>
                    </select></td>
                    
                </tr>
                <tr>
                    <td class="tg-lnq4">TAJUK PROGRAM</td>
                    <td class="tg-fa12"><textarea class="form-control" name="program" style="width:250px;height:90px" required >{{$data['program']}}</textarea></td>
                ...
                <tr>
                    ...
                    <td class="tg-fa12"><input type="date" class="form-control" name="tarikhA" style="width:250px;height:25px" value="{{$data['tarikhA']}}" /></td>
                    <td class="tg-lnq4">TARIKH TAMAT</td>
                    <td class="tg-fa12"><input type="date" class="form-control" name="tarikhB" style="width:250px;height:25px" value="{{$data['tarikhB']}}" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="tg-fa12"><input type="text" class="form-control" name="logopath" style="width:250px;height:25px;text-transform:uppercase" value="{{$data['logopath']}}" required /></td>
