...
<table  class="table table-bordered table-striped table-md">
  ...
  <td>{{$target->ic}} </td>
  <td>{{$target->kodsekolah}} </td>
  <td>{{$target->peserta}} </td>
  <td>{{$target->sekolah}} </td>
  <td>{{$target->anjuran}} </td>
  <td>
    
        <a href="{{ route('pdf.guest2', $target->id) }}" class="btn btn-default btn-sm" role="button" aria-pressed="true"><i class="fa fa-download" style="font-size:18px;color:black">&nbsp;muatturun</i></a>
  </td>
